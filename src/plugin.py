...
def getProviderChoices():
    return [
        ("none", _("None")),
        ("viasat", _("Viasat")),
        ("viasat_lat", _("Viasat Latvija")),
        ("viasat_ukr", _("Viasat Ukraine") + " (Amos)"),
        ("xtratv", _("Xtra TV")),
        ("ntv", _("NTV Plus")),
        ("tricolor", _("Tricolor TV")),
        ("ntv_vostok", _("NTV Plus Vostok")),
        ("tricolor_sibir", _("Tricolor TV Sibir")),
        ("otautv", _("Otau TV")),
        ("mtstv", _("MTS TV")),
        ("kontinent", _("Telekarta (HD)")),
